...
describe "multiply" do
  it "multiplies two numbers" do #rajouter le do
    expect(multiply(4,2)).to eq(8) #un exemple d'opération à vérifier: 4*2 = 8
  end

  it "multiplies several numbers" do #rajouter do
  expect(multiply(2,2,2)).to eq(8) #exemple : 2*2*2 = 8
end
end

describe "#power" do
  it "raises one number to the power of another number" do #rajouter do
  expect(power(2,2)).to eq(4) #exemple 2**2 = 4
  end
end
